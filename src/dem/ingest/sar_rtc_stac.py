...
from dem.config import DEFAULT_REGION, DEFAULT_SAR_SATELLITE, REGIONS, SAR_SATELLITES  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  python -m dem.ingest.sar_rtc_stac download --help\n"
            "  python -m dem.ingest.sar_rtc_stac list --help"
        ),
    )
    ...
    common.add_argument(
        ...
        type=str,
        default="",
        help="Базовая папка; пусто = outputs/<дата>/data/raw (VKR_RUN_DATE).",
    )
...
def download_command(args: argparse.Namespace) -> None:
    ...
    run_dir = _make_run_dir(out_base, run_tag)
