...
# Регион по умолчанию для пайплайнов (узкий полигон Хоста–Мзымта)
DEFAULT_REGION = "sochi_khosta_mzymta_small"

# Широкий bbox для тяжёлых экспериментов / обзорных снимков
WIDE_OVERVIEW_REGION = "sochi_khosta_mzymta_wide"
